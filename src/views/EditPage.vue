    ...
    <v-container>
        <v-content>
            <v-toolbar dense flat>
                ...
                <v-btn text @click="UpdatePage">SAVE
                </v-btn>
  ...
  <!--Content Section Editor-->
                                                                ...
                                                                <v-list-item>
                                                                    <v-list-item-content>
                                                                        <template>
                                                                            ...
                                                                            <button v-if="Array.isArray(CarouselAddReturnURL1) === true  && CarouselAddReturnURL1.length !== 0" @click.prevent="CarouselPickImage1">change</button>
                                                                            <button ref="CarouselImageRemoveButton1" v-if="Array.isArray(CarouselAddReturnURL1) === true && CarouselAddReturnURL1.length !== 0" @click.prevent="RemoveCarouselContentDialog1()">remove</button>
                                                                        </template>
                                                                    </v-list-item-content>
                                                                </v-list-item>
            ...
            <v-layout row wrap>
                <v-flex xs12 sm12 md12 class="d-flex align-content-center justify-center flex-wrap">
                    ...
                    <v-card title="Returned values:" v-if="Array.isArray(CarouselAddReturnURL1) === true && CarouselAddReturnURL1.length !== 0 && ActivatedSection2">
                        <template>
                            <v-btn bottom left v-if="ActivatedSection2" class="ml-5" x-small dark fab color="red" @click="RemoveContentSection1">
                                <v-icon>mdi-minus</v-icon>
                            </v-btn>
                                                            ...
                                                            <v-list>
                                                                <v-list-item>
                                                                    <v-list-item-content><template>
                                                                            ...
                                                                            <button v-if="Array.isArray(CarouselAddReturnURL2) === true && CarouselAddReturnURL2.length !== 0" @click.prevent="CarouselPickImage2">change</button>

                                                                            <button ref="CarouselImageRemoveButton2" v-if="Array.isArray(CarouselAddReturnURL2) === true && CarouselAddReturnURL2.length !== 0" @click.prevent="RemoveCarouselContentDialog2(CarouselAddReturnURL2)">remove</button>
                                                                        </template>
                                                                    </v-list-item-content>
                                                                </v-list-item>
            ...
            <v-layout row wrap>
                <v-flex xs12 sm12 md12 class="d-flex align-content-center justify-center flex-wrap">
                    ...
                    <!--Carousel Added Display-->
                    <v-card title="Returned values:" v-if="Array.isArray(CarouselAddReturnURL2) === true && CarouselAddReturnURL2.length !== 0 && ActivatedSection3">
                        <template>
                                                            ...
                                                            <v-list>
                                                                <v-list-item>
                                                                    <v-list-item-content><template>
                                                                            ...
                                                                            <button v-if="Array.isArray(CarouselAddReturnURL3) === true && CarouselAddReturnURL3.length !== 0" @click.prevent="CarouselPickImage3">change</button>
                                                                            <button ref="CarouselImageRemoveButton3" v-if="Array.isArray(CarouselAddReturnURL3) === true && CarouselAddReturnURL3.length !== 0" @click.prevent="RemoveCarouselContentDialog3(CarouselAddReturnURL3)">remove</button>
                                                                        </template>
                                                                    </v-list-item-content>
                                                                </v-list-item>
            ...
            <v-layout row wrap>
                <v-flex xs12 sm12 md12 class="d-flex align-content-center justify-center flex-wrap">
                    ...
                    <!--Carousel Added Display-->
                    <v-card title="Returned values:" v-if="Array.isArray(CarouselAddReturnURL3) === true && CarouselAddReturnURL3.length !== 0 && ActivatedSection4">
                        <template>
                                                                ...
                                                                <v-list-item>
                                                                    <v-list-item-content>
                                                                        <template>
                                                                            ...
                                                                            <button v-if="Array.isArray(CarouselAddReturnURL4) === true && CarouselAddReturnURL4.length !== 0" @click.prevent="CarouselPickImage4">change</button>
                                                                            <button ref="CarouselImageRemoveButton4" v-if="Array.isArray(CarouselAddReturnURL4) === true && CarouselAddReturnURL4.length !== 0" @click.prevent="RemoveCarouselContentDialog24(CarouselAddReturnURL4)">remove</button>
                                                                        </template>
                                                                    </v-list-item-content>
                                                                </v-list-item>
            ...
            <v-layout row wrap>
                <v-flex xs12 sm12 md12 class="d-flex align-content-center justify-center flex-wrap">
                    ...
                    <!--Carousel Added Display-->
                    <v-card title="Returned values:" v-if="Array.isArray(CarouselAddReturnURL4) === true && CarouselAddReturnURL4.length !== 0 && ActivatedSection5">
                        <template>
                                                                ...
                                                                <v-list-item>
                                                                    <v-list-item-content>
                                                                        <template>
                                                                            ...
                                                                            <button v-if="Array.isArray(CarouselAddReturnURL5) === true && CarouselAddReturnURL5.length !== 0" @click.prevent="CarouselPickImage5">change</button>
                                                                            <button ref="CarouselImageRemoveButton5" v-if="Array.isArray(CarouselAddReturnURL5) === true && CarouselAddReturnURL5.length !== 0" @click.prevent="RemoveCarouselContentDialog5(CarouselAddReturnURL5)">remove</button>
                                                                        </template>
                                                                    </v-list-item-content>
                                                                </v-list-item>
            ...
            <v-layout row wrap>
                <v-flex xs12 sm12 md12 class="d-flex align-content-center justify-center flex-wrap">
                    ...
                    <!--Carousel Added Display-->
                    <v-card title="Returned values:" v-if="Array.isArray(CarouselAddReturnURL5) === true && CarouselActive5 === true && ActivatedSection5">
                        <template>
                        ...
                        <v-dialog v-model="PreviewDialog" fullscreen hide-overlay transition="dialog-bottom-transition">
                            <v-card>
                                ...
                                <v-toolbar dark color="primary">
                                    ...
                                    <!-------Save Event---------------------------->
                                    <v-toolbar-items>
                                        <v-btn dark text @click="UpdatePage">Save</v-btn>
                                    </v-toolbar-items>
                                </v-toolbar>
                                <!--Title Section Card-->
                                ...
                                <v-card flat class="mt-5 d-flex align-content-center justify-center flex-wrap" title="Content Section 1:">
                                    ...
                                    <v-card xs12 sm12 md12 lg12 flat class="mt-5" title="Content Type Carousel" v-if="Array.isArray(CarouselAddReturnURL1) === true && CarouselActive1 === true">
                                        <v-layout row wrap>
                                ...
                                <v-card flat class="mt-5" title="Content Section 2:">
                                    ...
                                    <v-card xs12 sm12 md12 lg12 flat class="mt-5" title="Content Type Carousel 2" v-if="Array.isArray(CarouselAddReturnURL2) === true && CarouselActive2 === true">
                                        <v-layout row wrap>
                                            <v-flex xs12 sm12 md12 class="d-flex align-content-center justify-center flex-wrap align-items-center align-lg-content-center align-md-content-center">
                                                <v-responsive :aspect-ratio="16/9" lg-height="1080px" max-height="1080px">
                                                    <v-card flat class="mt-4 mx-auto elevation-0">
                                ...
                                <v-card flat class="mt-5" title="Content Section 3:">
                                    ...
                                    <v-card xs12 sm12 md12 lg12 flat class="mt-5" title="Content Type Carousel 3" v-if="Array.isArray(CarouselAddReturnURL3) === true && CarouselActive3 === true">
                                        <v-layout row wrap>
                                            <v-flex xs12 sm12 md12 class="d-flex align-content-center justify-center flex-wrap align-items-center align-lg-content-center align-md-content-center">
                                                <v-responsive :aspect-ratio="16/9" lg-height="1080px" max-height="1080px">
                                                    <v-card flat class="mt-4 mx-auto elevation-0">
                                ...
                                <v-card flat class="mt-5" title="Content Section 4:">
                                    ...
                                    <v-card xs12 sm12 md12 lg12 flat class="mt-5" title="Content Type Carousel 4" v-if="Array.isArray(CarouselAddReturnURL4) === true && CarouselActive4 === true">
                                        <v-layout row wrap>
                                            <v-flex xs12 sm12 md12 class="d-flex align-content-center justify-center flex-wrap align-items-center align-lg-content-center align-md-content-center">
                                                <v-responsive :aspect-ratio="16/9" lg-height="1080px" max-height="1080px">
                                                    <v-card flat class="mt-4 mx-auto elevation-0">
                                ...
                                <v-card flat class="mt-5" title="Content Section 5:">
                                    ...
                                    <v-card xs12 sm12 md12 lg12 flat class="mt-5" title="Content Type Carousel" v-if="Array.isArray(CarouselAddReturnURL5) === true && CarouselActive5 === true">
                                        <v-layout row wrap>
                                            <v-flex xs12 sm12 md12 class="d-flex align-content-center justify-center flex-wrap align-items-center align-lg-content-center align-md-content-center">
                                                <v-responsive :aspect-ratio="16/9" lg-height="1080px" max-height="1080px">
                                                    <v-card flat class="mt-4 mx-auto elevation-0">
...
export default {
    ...
    data: () => {
        return ({
            ...
            ImageActiveSection1: null,
            ImageAddReturnURL1: null,
            ImageAddReturn1: null,
            CarouselActive1: null,
            CarouselAddReturnURL1: null,
            CarouselAddReturn1: null,
            TextAddReturn1: null,
            LinkURLAdd1: null,
            VideoURLAdd1: null,
            YoutubeVideoID: null,
            ButtonNameAdd1: null,
            TextContent1: null,
            VideoAddReturn1: null,
            VideoId1: null,
            ButtonURLAdd1: null,
            ButtonAddReturn1: null,
            LinkURLAddReturn1: null,

            ImageActiveSection2: null,
            ImageAddReturnURL2: null,
            ImageAddReturn2: null,
            CarouselActive2: null,
            CarouselAddReturnURL2: null,
            CarouselAddReturn2: null,
            TextAddReturn2: null,
            LinkURLAdd2: null,
            VideoURLAdd2: null,
            YoutubeVideoID2: null,
            ButtonNameAdd2: null,
            TextContent2: null,
            VideoAddReturn2: null,
            VideoId2: null,
            ButtonURLAdd2: null,
            ButtonAddReturn2: null,
            LinkURLAddReturn2: null,

            ImageActiveSection3: null,
            ImageAddReturnURL3: null,
            ImageAddReturn3: null,
            CarouselActive3: null,
            CarouselAddReturnURL3: null,
            CarouselAddReturn3: null,
            TextAddReturn3: null,
            LinkURLAdd3: null,
            VideoURLAdd3: null,
            YoutubeVideoID3: null,
            ButtonNameAdd3: null,
            TextContent3: null,

            VideoAddReturn3: null,
            VideoId3: null,
            ButtonURLAdd3: null,
            ButtonAddReturn3: null,
            LinkURLAddReturn3: null,

            ImageActiveSection4: null,
            ImageAddReturnURL4: null,
            ImageAddReturn4: null,
            CarouselActive4: null,
            CarouselAddReturnURL4: null,
            CarouselAddReturn4: null,
            TextAddReturn4: null,
            LinkURLAdd4: null,
            VideoURLAdd4: null,
            YoutubeVideoID4: null,
            ButtonNameAdd4: null,
            TextContent4: null,

            VideoAddReturn4: null,
            VideoId4: null,
            ButtonURLAdd4: null,
            ButtonAddReturn4: null,
            LinkURLAddReturn4: null,

            ImageActiveSection5: null,
            ImageAddReturnURL5: null,
            ImageAddReturn5: null,
            CarouselActive5: null,
            CarouselAddReturnURL5: null,
            CarouselAddReturn5: null,
            TextAddReturn5: null,
            LinkURLAdd5: null,
            VideoURLAdd5: null,
            YoutubeVideoID5: null,
            ButtonNameAdd5: null,
            TextContent5: null,
            VideoAddReturn5: null,
            VideoId5: null,
            ButtonURLAdd5: null,
            ButtonAddReturn5: null,
            LinkURLAddReturn5: null,
            ...
            //Activated Content Section
            ActivatedSection2: null,
            ActivatedSection3: null,
            ActivatedSection4: null,
            ActivatedSection5: null,
    ...
    beforeRouteEnter(to, from, next) {
        db.collection('yourpages').where('PageID', '==', to.params.PageID).get()
            .then(querySnapshot => {
                querySnapshot.forEach(doc => {
                    next(vm => {
                        vm.id = doc.id
                        vm.PageID = doc.data().PageID
                        vm.PageTitle = doc.data().PageTitle
                        vm.PageSubTitle = doc.data().PageSubTitle
                        vm.TitleImage = doc.data().TitleImage
                        vm.TitleImageURL = doc.data().TitleImageURL

                        vm.ImageActiveSection1 = doc.data().ImageActiveSection1
                        vm.ImageAddReturnURL1 = doc.data().ImageAddReturnURL1
                        vm.TextAddReturn1 = doc.data().TextAddReturn1
                        vm.TextContent1 = doc.data().TextContent1
                        vm.CarouselActive1 = doc.data().CarouselActive1
                        vm.CarouselAddReturnURL1 = doc.data().CarouselAddReturnURL1
                        vm.VideoAddReturn1 = doc.data().VideoAddReturn1
                        vm.VideoId1 = doc.data().VideoId1
                        vm.ButtonURLAdd1 = doc.data().ButtonURLAdd1
                        vm.ButtonAddReturn1 = doc.data().ButtonAddReturn1
                        vm.LinkURLAddReturn1 = doc.data().LinkURLAddReturn1
                        vm.ButtonNameAdd1 = doc.data().ButtonNameAdd1
                        vm.LinkURLAdd1 = doc.data().LinkURLAdd1
                        vm.VideoURLAdd1 = doc.data().VideoURLAdd1

                        vm.ImageActiveSection2 = doc.data().ImageActiveSection2
                        vm.ImageAddReturnURL2 = doc.data().ImageAddReturnURL2
                        vm.TextAddReturn2 = doc.data().TextAddReturn2
                        vm.TextContent2 = doc.data().TextContent2
                        vm.CarouselActive2 = doc.data().CarouselActive2
                        vm.CarouselAddReturnURL2 = doc.data().CarouselAddReturnURL2
                        vm.VideoAddReturn2 = doc.data().VideoAddReturn2
                        vm.VideoId2 = doc.data().VideoId2
                        vm.ButtonURLAdd2 = doc.data().ButtonURLAdd2
                        vm.ButtonAddReturn2 = doc.data().ButtonAddReturn2
                        vm.LinkURLAddReturn2 = doc.data().LinkURLAddReturn2
                        vm.ButtonNameAdd2 = doc.data().ButtonNameAdd2
                        vm.LinkURLAdd2 = doc.data().LinkURLAdd2
                        vm.VideoURLAdd2 = doc.data().VideoURLAdd2

                        vm.ImageActiveSection3 = doc.data().ImageActiveSection3
                        vm.ImageAddReturnURL3 = doc.data().ImageAddReturnURL3
                        vm.TextAddReturn3 = doc.data().TextAddReturn3
                        vm.TextContent3 = doc.data().TextContent3
                        vm.CarouselActive3 = doc.data().CarouselActive3
                        vm.CarouselAddReturnURL3 = doc.data().CarouselAddReturnURL3
                        vm.VideoAddReturn3 = doc.data().VideoAddReturn3
                        vm.VideoId3 = doc.data().VideoId3
                        vm.ButtonURLAdd3 = doc.data().ButtonURLAdd3
                        vm.ButtonAddReturn3 = doc.data().ButtonAddReturn3
                        vm.LinkURLAddReturn3 = doc.data().LinkURLAddReturn3
                        vm.ButtonNameAdd3 = doc.data().ButtonNameAdd3
                        vm.LinkURLAdd3 = doc.data().LinkURLAdd3
                        vm.VideoURLAdd3 = doc.data().VideoURLAdd3

                        vm.ImageActiveSection4 = doc.data().ImageActiveSection4
                        vm.ImageAddReturnURL4 = doc.data().ImageAddReturnURL4
                        vm.TextAddReturn4 = doc.data().TextAddReturn4
                        vm.TextContent4 = doc.data().TextContent4
                        vm.CarouselActive4 = doc.data().CarouselActive4
                        vm.CarouselAddReturnURL4 = doc.data().CarouselAddReturnURL4
                        vm.VideoAddReturn4 = doc.data().VideoAddReturn4
                        vm.VideoId4 = doc.data().VideoId4
                        vm.ButtonURLAdd4 = doc.data().ButtonURLAdd4
                        vm.ButtonAddReturn4 = doc.data().ButtonAddReturn4
                        vm.LinkURLAddReturn4 = doc.data().LinkURLAddReturn4
                        vm.ButtonNameAdd4 = doc.data().ButtonNameAdd4
                        vm.LinkURLAdd4 = doc.data().LinkURLAdd4
                        vm.VideoURLAdd4 = doc.data().VideoURLAdd4

                        vm.ImageActiveSection5 = doc.data().ImageActiveSection5
                        vm.ImageAddReturnURL5 = doc.data().ImageAddReturnURL5
                        vm.TextAddReturn5 = doc.data().TextAddReturn5
                        vm.TextContent5 = doc.data().TextContent5
                        vm.CarouselActive5 = doc.data().CarouselActive5
                        vm.CarouselAddReturnURL5 = doc.data().CarouselAddReturnURL5
                        vm.VideoAddReturn5 = doc.data().VideoAddReturn5
                        vm.VideoId5 = doc.data().VideoId5
                        vm.ButtonURLAdd5 = doc.data().ButtonURLAdd5
                        vm.ButtonAddReturn5 = doc.data().ButtonAddReturn5
                        vm.LinkURLAddReturn5 = doc.data().LinkURLAddReturn5
                        vm.ButtonNameAdd5 = doc.data().ButtonNameAdd5
                        vm.LinkURLAdd5 = doc.data().LinkURLAdd5
                        vm.VideoURLAdd5 = doc.data().VideoURLAdd5

                        vm.ActivatedSection2 = doc.data().ActivatedSection2
                        vm.ActivatedSection3 = doc.data().ActivatedSection3
                        vm.ActivatedSection4 = doc.data().ActivatedSection4
                        vm.ActivatedSection5 = doc.data().ActivatedSection5

                        vm.FacebookAccount = doc.data().FacebookAccount
                        vm.InstagramAccount = doc.data().InstagramAccount
                        vm.LineAccount = doc.data().LineAccount

                        /* vm.ImageDialog = doc.data().ImageDialog
                         vm.TextDialog = doc.data().TextDialog
                         vm.CarouselDialog = doc.data().CarouselDialog
                         vm.VideoDialog = doc.data().VideoDialog
                         vm.ButtonDialog = doc.data().ButtonDialog
                         vm.LinkDialog = doc.data().LinkDialog*/
    ...
    methods: {
        fethData() {
            ...
            db.collection('yourpages').where('PageID', '==',
                    this.$route.params.PageID).get()
                .then(querySnapshot => {
                    querySnapshot.forEach(doc => {
                        this.id = doc.id
                        this.PageID = doc.data().PageID
                        this.PageTitle = doc.data().PageTitle
                        this.PageSubTitle = doc.data().PageSubTitle
                        //this.TitleImage = doc.data().TitleImage
                        this.TitleImageURL = doc.data().TitleImageURL
                        console.log(this.TitleImageURL)
                        this.fab = doc.data().fab
                        this.ImageActiveSection1 = doc.data().ImageActiveSection1
                        this.ImageAddReturnURL = doc.data().ImageAddReturnURL
                        this.TextAddReturn1 = doc.data().TextAddReturn1
                        this.TextContent1 = doc.data().TextContent1
                        this.CarouselActive1 = doc.data().CarouselActive1
                        this.CarouselAddReturnURL1 = doc.data().CarouselAddReturnURL1
                        this.VideoAddReturn1 = doc.data().VideoAddReturn1
                        this.VideoId1 = doc.data().VideoId1
                        this.ButtonURLAdd1 = doc.data().ButtonURLAdd1
                        this.ButtonAddReturn1 = doc.data().ButtonAddReturn1
                        this.LinkURLAddReturn1 = doc.data().LinkURLAddReturn1
                        this.ButtonNameAdd1 = doc.data().ButtonNameAdd1
                        this.LinkURLAdd1 = doc.data().LinkURLAdd1
                        this.VideoURLAdd1 = doc.data().VideoURLAdd1

                        this.TextAddReturn2 = doc.data().TextAddReturn2
                        this.TextContent2 = doc.data().TextContent2
                        this.ImageActiveSection2 = doc.data().ImageActiveSection2
                        this.ImageAddReturnURL2 = doc.data().ImageAddReturnURL2
                        this.CarouselAddReturnURL2 = doc.data().CarouselAddReturnURL2
                        this.CarouselActive2 = doc.data().CarouselActive2
                        this.VideoAddReturn2 = doc.data().VideoAddReturn2
                        this.VideoId2 = doc.data().VideoId2
                        this.ButtonURLAdd2 = doc.data().ButtonURLAdd2
                        this.ButtonAddReturn2 = doc.data().ButtonAddReturn2
                        this.LinkURLAddReturn2 = doc.data().LinkURLAddReturn2

                        this.TextAddReturn3 = doc.data().TextAddReturn3
                        this.TextContent3 = doc.data().TextContent3
                        this.ImageActiveSection3 = doc.data().ImageActiveSection3
                        this.ImageAddReturnURL3 = doc.data().ImageAddReturnURL3
                        this.CarouselActive3 = doc.data().CarouselActive3
                        this.CarouselAddReturnURL3 = doc.data().CarouselAddReturnURL3
                        this.VideoAddReturn3 = doc.data().VideoAddReturn3
                        this.VideoId3 = doc.data().VideoId3
                        this.ButtonURLAdd3 = doc.data().ButtonURLAdd3
                        this.ButtonAddReturn3 = doc.data().ButtonAddReturn3
                        this.LinkURLAddReturn3 = doc.data().LinkURLAddReturn3

                        this.TextAddReturn4 = doc.data().TextAddReturn4
                        this.TextContent4 = doc.data().TextContent4
                        this.ImageActiveSection4 = doc.data().ImageActiveSection4
                        this.ImageAddReturnURL4 = doc.data().ImageAddReturnURL4
                        this.CarouselActive4 = doc.data().CarouselActive4
                        this.CarouselAddReturnURL4 = doc.data().CarouselAddReturnURL4
                        this.CarouselAddReturn4 = doc.data().CarouselAddReturn4
                        this.VideoAddReturn4 = doc.data().VideoAddReturn4
                        this.VideoId4 = doc.data().VideoId4
                        this.ButtonURLAdd4 = doc.data().ButtonURLAdd4
                        this.ButtonAddReturn4 = doc.data().ButtonAddReturn4
                        this.LinkURLAddReturn4 = doc.data().LinkURLAddReturn4

                        this.TextAddReturn5 = doc.data().TextAddReturn5
                        this.TextContent5 = doc.data().TextContent5
                        this.ImageActiveSection5 = doc.data().ImageActiveSection5
                        this.ImageAddReturnURL5 = doc.data().ImageAddReturnURL5
                        this.CarouselActive5 = doc.data().CarouselActive5
                        this.CarouselAddReturnURL5 = doc.data().CarouselAddReturnURL5
                        this.CarouselAddReturn5 = doc.data().CarouselAddReturn5
                        this.VideoAddReturn5 = doc.data().VideoAddReturn5
                        this.VideoId5 = doc.data().VideoId5
                        this.ButtonURLAdd5 = doc.data().ButtonURLAdd5
                        this.ButtonAddReturn5 = doc.data().ButtonAddReturn5
                        this.LinkURLAddReturn5 = doc.data().LinkURLAddReturn5
                        //Add Contact data

                        /*this.ImageDialog = doc.data().ImageDialog
                        this.TextDialog = doc.data().TextDialog
                        this.CarouselDialog = doc.data().CarouselDialog
                        this.VideoDialog = doc.data().VideoDialog
                        this.ButtonDialog = doc.data().ButtonDialog
                        this.LinkDialog = doc.data().LinkDialog*/
                        this.FacebookAccount = doc.data().FacebookAccount
                        this.LineAccount = doc.data().LineAccount
                        this.InstagramAccount = doc.data().InstagramAccount

                          this.ActivatedSection2 = doc.data().ActivatedSection2
                        this.ActivatedSection3 = doc.data().ActivatedSection3
                        this.ActivatedSection4 = doc.data().ActivatedSection4
                        this.ActivatedSection5 = doc.data().ActivatedSection5
                    })
                })
        },
         //TiTile Image method
        ...
        ExternalLink() {
            let routeData = this.LinkURLAddReturn1 || this.ButtonURLAdd1 || this.FacebookAccount || this.InstagramAccount || this.LineAccount || this.LinkURLAddReturn2 || this.ButtonURLAdd2 ||
                ...
                .then(querySnapshot => {
                    querySnapshot.forEach(doc => {
                        doc.ref.update({
                                ...
                                CarouselDialog: this.CarouselDialog,
                                VideoDialog: this.VideoDialog,
                                ButtonDialog: this.ButtonDialog,
                                LinkDialog: this.ButtonDialog,*/
                            ...
                            .then(() => {
                                ...
                                //this.$router.push({name: 'view-page',
